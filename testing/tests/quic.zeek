...
# @TEST-EXEC: zeek-cut -m npf <quic-chromium-115.0.5790.110-api-cirrus-com.log >quic-chromium-115.0.5790.110-api-cirrus-com.log.cut
# @TEST-EXEC: zeek-cut -m npf <quic-firefox-102.13.0esr-blog-cloudflare-com.pcap.log >quic-firefox-102.13.0esr-blog-cloudflare-com.pcap.log.cut
